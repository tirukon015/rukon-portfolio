...
/**
 * lucide-react dropped brand/logo glyphs (GitHub, LinkedIn, X) from its
 * core icon set. These are small hand-written replacements, sized and
 * styled to match the rest of the lucide icons used across the site.
 */
...
export function XIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M13.53 10.6 20.4 2.5h-2.3l-5.97 7.03L7.16 2.5H2l7.2 10.5L2 21.5h2.3l6.3-7.42 5.24 7.42H21l-7.47-10.9Zm-2.23 2.63-.73-1.04L4.77 4.19h2.03l4.7 6.7.73 1.04 6.13 8.76h-2.03l-4.97-7.06Z" />
    </svg>
  );
}
